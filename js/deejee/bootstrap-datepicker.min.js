  ...
  k.prototype = {
    ...
    _fill_yearsView: function (c, d, e, f, g, h, i, j) {
      ...
      for (
        ...
        (s = [d]), (t = null), -1 === r ? s.push("old") : 10 === r && s.push("new"), -1 !== a.inArray(q, n) && s.push("active"), (o > q || q > p) && s.push("disabled"), q === this.viewDate.getFullYear() && s.push("focused"), j !== a.noop && ((u = j(new Date(q, 0, 1))), u === b ? (u = {}) : "boolean" == typeof u ? (u = { enabled: u }) : "string" == typeof u && (u = { classes: u }), u.enabled === !1 && s.push("disabled"), u.classes && (s = s.concat(u.classes.split(/\s+/))), u.tooltip && (t = u.tooltip)), (k += '<span class="' + s.join(" ") + '"' + (t ? ' title="' + t + '"' : "") + ">" + q + "</span>"), (q += f);
      l.find("td").html(k);
    },
    fill: function () {
      var d,
    ...
    click: function (b) {
      ...
      l.length > 0 && ((f = r.modes[this.viewMode].navStep * (l.hasClass("prev") ? -1 : 1)), 0 === this.viewMode ? ((this.viewDate = this.moveMonth(this.viewDate, f)), this._trigger("changeMonth", this.viewDate)) : ((this.viewDate = this.moveYear(this.viewDate, f)), 1 === this.viewMode && this._trigger("changeYear", this.viewDate)), this.fill()),
        ...
        e.hasClass("disabled") ||
          (e.hasClass("day") && ((g = parseInt(e.text(), 10) || 1), (h = this.viewDate.getUTCFullYear()), (i = this.viewDate.getUTCMonth()), e.hasClass("old") && (0 === i ? ((i = 11), (h -= 1), (j = !0), (k = !0)) : ((i -= 1), (j = !0))), e.hasClass("new") && (11 === i ? ((i = 0), (h += 1), (j = !0), (k = !0)) : ((i += 1), (j = !0))), this._setDate(c(h, i, g)), k && this._trigger("changeYear", this.viewDate), j && this._trigger("changeMonth", this.viewDate)),
          e.hasClass("month") && (this.viewDate.setUTCDate(1), (g = 1), (i = e.parent().find("span").index(e)), (h = this.viewDate.getUTCFullYear()), this.viewDate.setUTCMonth(i), this._trigger("changeMonth", this.viewDate), 1 === this.o.minViewMode ? (this._setDate(c(h, i, g)), this.showMode()) : this.showMode(-1), this.fill()),
