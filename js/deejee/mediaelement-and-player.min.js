          ...
          (s.t = function (e) {
            ...
            if ("string" == typeof e && e.length) {
              var n = void 0,
                ...
                r = s.language(),
                l = function (e, t, n) {
                  return "object" !== (void 0 === e ? "undefined" : o(e)) || "number" != typeof t || "number" != typeof n
                    ? e
                    : [
                        function () {
      ...
      function (e, t, n) {
        ...
        var r =
          ...
          p = function e(t, n, o) {
            ...
            i(this, e);
            var m = this;
            (o = Array.isArray(o) ? o : null), (m.defaults = { renderers: [], fakeNodeName: "mediaelementwrapper", pluginPath: "build/", shimScriptAccess: "sameDomain" }), (n = Object.assign(m.defaults, n)), (m.mediaElement = s.default.createElement(n.fakeNodeName));
            var h = t,
              v = !1;
            ...
            if (null !== o) b = o;
              ...
              switch (((b = []), m.mediaElement.originalNode.nodeName.toLowerCase())) {
                case "iframe":
            ...
            return (
              ...
              m.mediaElement.promises.length
                ...
                : (m.mediaElement.options.success && m.mediaElement.options.success(m.mediaElement, m.mediaElement.originalNode), v && m.mediaElement.options.error && m.mediaElement.options.error(m.mediaElement, m.mediaElement.originalNode)),
              m.mediaElement
            );
          };
                ...
                },
                {
                  ...
                  value: function (e) {
                    ...
                    for (var r = 0, a = t.length; r < a; r++) {
                      var s = t[r],
                        l = this.renderers[s];
                      if (null !== l && void 0 !== l) for (var d = 0, u = e.length; d < u; d++) if ("function" == typeof l.canPlayType && "string" == typeof e[d].type && l.canPlayType(e[d].type)) return { rendererName: l.name, src: e[d].src };
                    }
                    return null;
                  },
                },
          ...
          Object.assign(l.default.prototype, {
            ...
            enterFullScreen: function () {
              ...
              if (!1 === e.options.useFakeFullscreen && d.IS_IOS && d.HAS_IOS_FULLSCREEN && "function" == typeof e.media.originalNode.webkitEnterFullscreen && e.media.originalNode.canPlayType((0, f.getTypeFromFile)(e.media.getSrc()))) e.media.originalNode.webkitEnterFullscreen();
                ...
                if (
                  ...
                  (0, c.addClass)(e.container, e.options.classPrefix + "container-fullscreen"),
                ...
                else for (var o = e.container.querySelectorAll("embed, object, video"), a = o.length, s = 0; s < a; s++) (o[s].style.width = "100%"), (o[s].style.height = "100%");
            ...
            exitFullScreen: function () {
              ...
              if ((clearTimeout(e.containerSizeTimeout), d.HAS_TRUE_NATIVE_FULLSCREEN && (d.IS_FULLSCREEN || e.isFullScreen) && d.cancelFullScreen(), (0, c.removeClass)(r.default.documentElement, e.options.classPrefix + "fullscreen"), (0, c.removeClass)(e.container, e.options.classPrefix + "container-fullscreen"), e.options.setDimensions)) {
                ...
                else for (var n = e.container.querySelectorAll("embed, object, video"), o = n.length, i = 0; i < o; i++) (n[i].style.width = e.normalWidth + "px"), (n[i].style.height = e.normalHeight + "px");
            ...
            buildprogress: function (e, t, n, o) {
              ...
              var y = function (t) {
                  ...
                  if (((h = t.originalEvent && t.originalEvent.changedTouches ? t.originalEvent.changedTouches[0].pageX : t.changedTouches ? t.changedTouches[0].pageX : t.pageX), p.getDuration())) {
                    if ((h < o.left ? (h = o.left) : h > i + o.left && (h = i + o.left), (m = h - o.left), (s = m / i), (p.newTime = s <= 0.02 ? 0 : s * p.getDuration()), c && null !== p.getCurrentTime() && p.newTime.toFixed(4) !== p.getCurrentTime().toFixed(4) && (p.setCurrentRailHandle(p.newTime), p.updateCurrent(p.newTime)), !l.IS_IOS && !l.IS_ANDROID)) {
    ...
    13: [
      function (e, t, n) {
        ...
        var i = o(e(2)),
          ...
          u = e(27),
          c = e(26);
        Object.assign(s.config, { startLanguage: "", tracksText: null, chaptersText: null, tracksAriaLive: !1, hideCaptionsButtonWhenEmpty: !0, toggleCaptionsButtonWhenOnlyOne: !1, slidesSelector: "" }),
          Object.assign(l.default.prototype, {
            hasChapters: !1,
            buildtracks: function (e, t, n, o) {
              if ((this.findTracks(), e.tracks.length || (e.trackFiles && 0 !== !e.trackFiles.length))) {
                ...
                if (r.options.toggleCaptionsButtonWhenOnlyOne && 1 === m)
                  ...
                  for (var S = e.captionsButton.querySelectorAll("." + r.options.classPrefix + "captions-selector-label"), x = e.captionsButton.querySelectorAll("input[type=radio]"), w = 0, P = b.length; w < P; w++)
                ...
                e.chaptersButton.addEventListener("keydown", function (e) {
                  ...
                  e.options.alwaysShowControls
                    ...
                    : (e.container.addEventListener("controlsshown", function () {
                        (0, c.addClass)(e.container.querySelector("." + r.options.classPrefix + "captions-position"), r.options.classPrefix + "captions-position-hover");
                      }),
              ...
              parse: function (e) {
                for (var t = e.split(/\r?\n/), n = [], o = void 0, i = void 0, r = void 0, a = 0, s = t.length; a < s; a++) {
                  if ((o = this.pattern.exec(t[a])) && a < t.length) {
                    ...
                    (i = i.trim().replace(/(\b(https?|ftp|file):\/\/[-A-Z0-9+&@#\/%?=~_|!:,.;]*[-A-Z0-9+&@#\/%=~_|])/gi, "<a href='$1' target='_blank'>$1</a>")), n.push({ identifier: r, start: 0 === (0, d.convertSMPTEtoSeconds)(o[1]) ? 0.2 : (0, d.convertSMPTEtoSeconds)(o[1]), stop: (0, d.convertSMPTEtoSeconds)(o[3]), text: i, settings: o[5] });
                  }
                  r = "";
                }
                return n;
    ...
    14: [
      function (e, t, n) {
        ...
        var i = o(e(2)),
          ...
          d = e(27),
          u = e(26);
        Object.assign(r.config, { muteText: null, unmuteText: null, allyVolumeControlText: null, hideVolumeOnTouchDevices: !0, audioVolume: "horizontal", videoVolume: "vertical", startVolume: 0.8 }),
          Object.assign(a.default.prototype, {
            buildvolume: function (e, t, n, o) {
              if ((!l.IS_ANDROID && !l.IS_IOS) || !this.options.hideVolumeOnTouchDevices) {
                ...
                if (
                  ((h.className = a.options.classPrefix + "button " + a.options.classPrefix + "volume-button " + a.options.classPrefix + "mute"),
                ...
                o.addEventListener("rendererready", function () {
                  ...
                  (0 === e.options.startVolume || o.originalNode.muted) && (o.setMuted(!0), (e.options.startVolume = 0), k()),
            ...
            if (((o.node = o.media = r), o.node)) {
              ...
              if (((o.isDynamic = "audio" !== c && "video" !== c && "iframe" !== c), (o.isVideo = o.isDynamic ? o.options.isVideo : "audio" !== c && o.options.isVideo), (o.mediaFiles = null), (o.trackFiles = null), (p.IS_IPAD && o.options.iPadUseNativeControls) || (p.IS_IPHONE && o.options.iPhoneUseNativeControls))) o.node.setAttribute("controls", !0), p.IS_IPAD && o.node.getAttribute("autoplay") && o.play();
                ...
                if (
                  ...
                  (o.container.id = o.id),
                  (o.container.className = o.options.classPrefix + "container " + o.options.classPrefix + "container-keyboard-inactive " + o.media.className),
                  ...
                  o.options.features.length || o.options.useDefaultControls || ((o.container.style.background = "transparent"), (o.container.querySelector("." + o.options.classPrefix + "controls").style.display = "none")),
            ...
            a(e, [
                  ...
                  if (((e = void 0 === e || e), !t.controlsAreVisible && t.isVideo)) {
                    if (e)
                      !(function () {
                        ...
                        for (var e = t.container.querySelectorAll("." + t.options.classPrefix + "control"), n = 0, o = e.length; n < o; n++)
                          !(function (n, o) {
                  ...
                  if (((e = void 0 === e || e), !0 === t || !(!n.controlsAreVisible || n.options.alwaysShowControls || (n.paused && 4 === n.readyState && ((!n.options.hideVideoControlsOnLoad && n.currentTime <= 0) || (!n.options.hideVideoControlsOnPause && n.currentTime > 0))) || (n.isVideo && !n.options.hideVideoControlsOnLoad && !n.readyState) || n.ended))) {
                    if (e)
                      !(function () {
                        ...
                        for (var e = n.container.querySelectorAll("." + n.options.classPrefix + "control"), t = 0, o = e.length; t < o; t++)
                          !(function (t, o) {
                      ...
                      n.container.dispatchEvent(v),
                        ...
                        n.isVideo &&
                          ...
                          (!p.IS_ANDROID && !p.IS_IOS) || n.options.alwaysShowControls
                            ? (n.container.addEventListener("mouseenter", function () {
              ...
              },
              {
                ...
                value: function () {
                  var e = this,
                    ...
                    r = (function () {
                      var t = 1;
                      return e.isVideo ? ((t = e.media.videoWidth && e.media.videoWidth > 0 && e.media.videoHeight && e.media.videoHeight > 0 ? (e.height >= e.width ? e.media.videoWidth / e.media.videoHeight : e.media.videoHeight / e.media.videoWidth) : e.initialAspectRatio), (isNaN(t) || t < 0.01 || t > 100) && (t = 1), t) : t;
                    })(),
              ...
              },
              {
                ...
                value: function (e, t, n, o) {
                  ...
                  "" !== e.options.poster && (a && p.IS_IOS && o.originalNode.removeAttribute("poster"), (a = e.options.poster)),
              ...
              },
              {
                ...
                value: function () {
                  ...
                  a ? -1 === a.indexOf("%") && (a += "px") : (a = "auto"),
                    ...
                    "object" === r(e.container) && (e.container.parentNode.querySelector("." + e.options.classPrefix + "offscreen").remove(), e.container.remove()),
            ...
            create: function (e, t, n) {
              ...
              for (
                var y = a.default.html5media.properties,
                  g = a.default.html5media.events.concat(["click", "mouseover", "mouseout"]),
                  b = function (t) {
                    if ("error" !== t.type) {
                      ...
                      if (-1 === a.default.html5media.readOnlyProperties.indexOf(e))
                        if ("src" === e) {
                          ...
                          if (((p[e] = o), null !== m)) {
                            ...
                            (m = f._createPlayer({ options: t.dash, id: d })), n && "object" === (void 0 === n ? "undefined" : i(n)) && "object" === i(n.drm) && (m.setProtectionData(n.drm), (0, l.isString)(t.dash.robustnessLevel) && t.dash.robustnessLevel && m.getProtectionController().setRobustnessLevel(t.dash.robustnessLevel)), m.attachSource(o), u && m.play();
                          }
                        } else p[e] = n;
                    });
                })(y[E]);
              if (
                ((r.default["__ready__" + d] = function (n) {
                  e.dashPlayer = m = n;
                  for (var o = dashjs.MediaPlayer.events, r = 0, s = g.length; r < s; r++)
                    !(function (e) {
    ...
    20: [
      function (e, t, n) {
            ...
            for (var p = s.default.html5media.properties, m = 0, h = p.length; m < h; m++)
              !(function (e) {
                ...
                (o["get" + t] = function () {
                  ...
                  (o["set" + t] = function (t) {
                    if (("src" === e && (t = (0, f.absolutizeUrl)(t)), null !== o.flashApi && void 0 !== o.flashApi["set_" + e]))
                      try {
                        o.flashApi["set_" + e](t);
                      } catch (e) {}
        ...
        if (p.hasPluginVersion("flash", [10, 0, 0])) {
          ...
          var h = {
            name: "flash_video",
            options: { prefix: "flash_video", filename: "mediaelement-flash-video.swf", enablePseudoStreaming: !1, pseudoStreamingStartQueryParam: "start", pseudoStreamingType: "byte" },
            canPlayType: function (e) {
            ...
            create: function (e, t, n) {
              ...
              for (
                var p = a.default.html5media.properties,
                  m = a.default.html5media.events.concat(["click", "mouseover", "mouseout"]),
                  h = function (t) {
                    if ("error" !== t.type) {
                      var n = (0, l.createEvent)(t.type, e);
                      e.dispatchEvent(n);
    ...
    22: [
      function (e, t, n) {
        ...
        var i =
          ...
          p = {
            name: "native_hls",
            options: { prefix: "native_hls", hls: { path: "https://cdnjs.cloudflare.com/ajax/libs/hls.js/0.8.2/hls.min.js", autoStartLoad: !1, debug: !1 } },
            canPlayType: function (e) {
        ...
        var i = o(e(3)),
          ...
          f = {
            ...
            create: function (e, t, n) {
              ...
              for (var h = a.default.html5media.properties, v = 0, y = h.length; v < y; v++)
                !(function (t) {
              ...
              for (var g = a.default.html5media.methods, b = 0, E = g.length; b < E; b++)
                !(function (e) {
                  o[e] = function () {
                    if (null !== d)
                      switch (e) {
              ...
              var x = "audio" === e.originalNode.tagName.toLowerCase(),
                ...
                C = {
                  ...
                  height: w,
                  width: P,
                  playerVars: Object.assign({ controls: 0, rel: 0, disablekb: 1, showinfo: 0, modestbranding: 0, html5: 1, playsinline: 0, start: 0, end: 0, iv_load_policy: 3 }, o.options.youtube),
